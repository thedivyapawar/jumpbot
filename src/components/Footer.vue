<template>
  ...
  <div class="block md:flex md:justify-between gap-4 w-[100%] md:w-[90%] my-4 items-center">
    <div class="w-[100%] md:w-[30%] justify-between md:justify-start">
      <p class="text-xs md:text-sm lg:text-md text-center mb-2">@2025 . All rights reserved</p>
    </div>

    <div class="flex justify-center md:items-center w-[100%] md:w-[30%]  text-mycolor mb-3 ">
      
        
          <a href="https://www.linkedin.com/in/heydivyapawar/" target="_blank">
           <span class="text-[12px] md:text-[18px] text-[#01afeb]">Developed by Divya Pawar</span>
            <i class="bi bi-arrow-right m-[10px] text-[#01afeb]"></i>
          </a>
       
    </div>

    <div class="flex gap-5 w-[100%] md:w-[30%] justify-between md:justify-end items-center">
        <span class="text-xs  md:text-sm lg:text-md">Privacy Policy</span>
        <span class="text-xs md:text-sm lg:text-md">Terms of Service</span>
        <span class="text-xs md:text-sm lg:text-md">Disclosure</span>
    </div>
  </div>
